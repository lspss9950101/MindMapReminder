...
class MeshBackground extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Offset offset = Offset(
        _doubleMod(canvasScaleOffsetProvider.overallOffset.dx, interval),
        _doubleMod(canvasScaleOffsetProvider.overallOffset.dy, interval));
    final double scale = canvasScaleOffsetProvider.overallScale;
